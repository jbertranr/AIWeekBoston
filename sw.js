/* ============================================================
   Boston AI Week 2026 — service worker
   Millora progressiva: després d'una primera càrrega correcta,
   l'aplicació (shell + catàleg + preferits/ruta, que ja viuen a
   localStorage) ha de funcionar sense connexió.

   NO es cachegen tessel·les de mapa (OSM) de manera indiscriminada
   — els servidors públics d'OpenStreetMap no ho permeten (norma
   web-vanilla). El mapa simplement no funcionarà sense connexió; la
   resta de l'app, sí.
   ============================================================ */
...
// tercers vendoritzats (Font Awesome, Leaflet) pràcticament no canvien
// un cop publicats: cau primer, estalvia dades i van més ràpid.
...
self.addEventListener("fetch", (event) => {
  ...
  // Fitxers de tercers vendoritzats: memòria cau primer.
  event.respondWith(
