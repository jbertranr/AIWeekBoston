/* ============================================================
   Boston AI Week 2026 — mida de lletra
   ...
   classe (aiwb-text-lg / aiwb-text-xl) que escala --ds-space-x i tots
   ...
   ============================================================ */
(function () {
  var STORAGE_KEY = "aiWeekBoston:midaLletra";
  var LEVELS = ["normal", "gran", "molt-gran"];
  var CLASS_BY_LEVEL = { normal: "", gran: "aiwb-text-lg", "molt-gran": "aiwb-text-xl" };
  ...
  function apply(level) {
    ...
    root.classList.remove("aiwb-text-lg", "aiwb-text-xl");
