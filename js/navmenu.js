/* ============================================================
   Boston AI Week 2026 — menú hamburguesa (#btn-open-nav → #dlg-nav)
...
(function () {
  ...
  function markActive() {
    ...
    document.querySelectorAll(".aiwb-nav-menu__item[data-nav-page]").forEach(function (a) {
  ...
  function wireItemClicks() {
    var dlg = document.getElementById("dlg-nav");
    if (!dlg) return;
    dlg.querySelectorAll(".aiwb-nav-menu__item").forEach(function (a) {
